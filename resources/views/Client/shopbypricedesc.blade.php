                ...
                <div class="row">
                    <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                        ...
                        <div class="shop-top-bar d-flex">
                            <p class="compare-product"> <span style="color: 
                            #726310;">12</span> Product Found of <span style="color: 
                            #726310;">{{ $nbProduct}}</span></p>
                            <!-- Left Side End -->
                            ...
                            <div class="select-shoing-wrap d-flex align-items-center">
                                ...
                                <div class="header-bottom-set dropdown">
                                    <button class="dropdown-toggle header-action-btn" data-bs-toggle="dropdown">  Price, high to low<i class="fa fa-angle-down"></i></button>
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a class="dropdown-item" href="/shop">Default</a></li>
                                        <li><a class="dropdown-item" href="/shopByName">Name, A to Z  </a></li>
                                        <li><a class="dropdown-item" href="/shopByAlphapbet">Name, Z to A</a></li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="shop-grid">
                                            <div class="row mb-n-30px">
                                                @foreach ($gadgetsByPage as $gadget)
                                                                ...
                                                                <div class="content-desc-wrap">
                                                                    ...
                                                                    <div class="box-inner">
                                                                        ...
                                                                        <div class="actions">
                                                                            ...
                                                                            <button title="Add To Cart" class="action add-to-cart" ><a href="https://www.example.com/checkout" style="color: aliceblue"><i
                                                                                class="pe-7s-shopbag"></i></a></button>
                                                                            
                                                                            <button class="action wishlist" title="Wishlist" ><a href="https://www.example.com/checkout" style="color: aliceblue"><i
                                                                                    class="pe-7s-like"></i></a></button>
                    ...
                    <div class="col-lg-3 order-lg-first col-md-12 order-md-last">
                        <div class="shop-sidebar-wrap">
                            ...
                            <div class="sidebar-widget">
                                <h4 class="sidebar-title">Gadget Categories</h4>
                                <div class="sidebar-widget-category">
                                    <ul>
                                        <li><a href="/shop" class="selected m-0"> All
                                                <span>({{ $nbProduct}})</span> </a></li>
                                        @foreach ($categories as $category)
                                        <li>
                                            <a href="/shopByCategory/{{ $category->category_name }}" class="">{{ $category->category_name }} <span>({{ $nbProductBycat[$category->category_name] }})</span></a>
                                        @endforeach
