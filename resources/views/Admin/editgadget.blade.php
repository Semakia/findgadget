    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit gadget </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <!-- Vertical Form -->
                    ...
                    {!!Form::open(['action' => 'GadgetController@editgadget', 'method' => 'POST', 'class' => 'row g-3', 'enctype' => 'multipart/form-data'])!!}
                     {{csrf_field()}}
                    <div class="col-12">
                        {{Form::hidden('id', $gadget->id)}}
                        {{Form::label('', 'Gadget'."'".'s Name', ['for' => 'inputNanme4' , 'class' =>'form-label'])}}
                        {{Form::text('gadget_name', $gadget->gadget_name, ['class' => 'form-control' , 'id'=>'inputNanme4'])}}
                    ...
                    <div class="col-12">
                        ...
                        {{Form::number('gadget_price', $gadget->gadget_price, ['class' => 'form-control' , 'id'=>'inputNanme4'])}}
                     {{--<label for="inputNanme4" class="form-label">Category's Name</label>
                      <input type="text" class="form-control" id="inputNanme4">--}} 
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        {{Form::select('gadget_category',  $categories , $gadget->gadget_category,  ['class' => 'form-control' , 'id'=>'inputNanme4'])}}
                     {{--<label for="inputNanme4" class="form-label">Category's Name</label>
                      <input type="text" class="form-control" id="inputNanme4">--}} 
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        {{Form::textarea('gadget_description', $gadget->description, ['class' => 'form-control' , 'id'=>'inputNanme4'])}}
                     {{--<label for="inputNanme4" class="form-label">Category's Name</label>
                      <input type="text" class="form-control" id="inputNanme4">--}} 
                    </div>
