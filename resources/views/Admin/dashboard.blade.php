                ...
                <div class="card-body">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      @foreach ($transformedCommandesByTd as $commandesByTd)
                        <tr>
                          <th scope="row">{{$increment}}</th>
                          <td>{{$commandesByTd->client_firstname}} {{$commandesByTd->client_lastname}}</td>
                          <td>
                            @foreach($commandesByTd->panier->items as $item)
                              {{$item['product_name'].' , '}}
                            @endforeach
                          </td>
                        </tr> 
