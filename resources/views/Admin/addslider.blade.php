    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Add Slider's infos</h5>
                  ...
                  <!-- Vertical Form -->
                    ...
                    {!!Form::open(['action' => 'SliderController@saveslider', 'method' => 'POST', 'class' => 'row g-3', 'enctype' => 'multipart/form-data'])!!}
                     {{csrf_field()}}
                    <div class="col-12">
                        {{Form::label('', 'Description one', ['for' => 'inputNanme4' , 'class' =>'form-label'])}}
                        {{Form::text('description1', '', ['class' => 'form-control' , 'id'=>'inputNanme4'])}}
                    ...
                    <div class="col-12">
                        ...
                        {{Form::text('description2', '', ['class' => 'form-control' , 'id'=>'inputNanme4'])}}
                     {{--<label for="inputNanme4" class="form-label">Category's Name</label>
                      <input type="text" class="form-control" id="inputNanme4">--}} 
                    </div>
